...
def _write_markdown_report(
    ...
    lines.append("")
    lines.append(f"Deliverable 5.5.5. Auto-generated by `uv run main.py error-analysis` -- "
                  f"regenerate rather than hand-edit; add commentary in a separate section of the README.")
    lines.append("")
